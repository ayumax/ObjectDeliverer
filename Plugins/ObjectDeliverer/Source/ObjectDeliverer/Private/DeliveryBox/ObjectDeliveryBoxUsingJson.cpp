...
bool UObjectDeliveryBoxUsingJson::JsonObjectToUObject(const TSharedPtr<FJsonObject>& JsonObject, UObject* OutObject)
{
...
bool UObjectDeliveryBoxUsingJson::JsonObjectToUStruct(const TSharedPtr<FJsonObject>& JsonObject, const UStruct* StructDefinition, void* OutStruct)
{
	auto& JsonAttributes = JsonObject->Values;
...
bool UObjectDeliveryBoxUsingJson::JsonValueToUProperty(const TSharedPtr<FJsonValue>& JsonValue, UProperty* Property, void* OutValue)
{
...
bool UObjectDeliveryBoxUsingJson::ConvertScalarJsonValueToUPropertyWithContainer(const TSharedPtr<FJsonValue>& JsonValue, UProperty* Property, void* OutValue)
{
...
bool UObjectDeliveryBoxUsingJson::JsonValueToUEnumProperty(const TSharedPtr<FJsonValue>& JsonValue, UEnumProperty* Property, void* OutValue)
{
...
bool UObjectDeliveryBoxUsingJson::JsonValueToUNumericProperty(const TSharedPtr<FJsonValue>& JsonValue, UNumericProperty *NumericProperty, void* OutValue)
{
...
bool UObjectDeliveryBoxUsingJson::JsonValueToUBoolProperty(const TSharedPtr<FJsonValue>& JsonValue, UBoolProperty *BoolProperty, void* OutValue)
{
...
bool UObjectDeliveryBoxUsingJson::JsonValueToUStrProperty(const TSharedPtr<FJsonValue>& JsonValue, UStrProperty *StringProperty, void* OutValue)
{
...
bool UObjectDeliveryBoxUsingJson::JsonValueToUArrayProperty(const TSharedPtr<FJsonValue>& JsonValue, UArrayProperty *ArrayProperty, void* OutValue)
{
...
bool UObjectDeliveryBoxUsingJson::JsonValueToUMapProperty(const TSharedPtr<FJsonValue>& JsonValue, UMapProperty* MapProperty, void* OutValue)
{
...
bool UObjectDeliveryBoxUsingJson::JsonValueToUSetProperty(const TSharedPtr<FJsonValue>& JsonValue, USetProperty* SetProperty, void* OutValue)
{
	if (JsonValue->Type == EJson::Array)
	{
		TArray< TSharedPtr<FJsonValue> > ArrayValue = JsonValue->AsArray();
...
bool UObjectDeliveryBoxUsingJson::JsonValueToUTextProperty(const TSharedPtr<FJsonValue>& JsonValue, UTextProperty* TextProperty, void* OutValue)
{
	if (JsonValue->Type == EJson::String)
	{
...
bool UObjectDeliveryBoxUsingJson::JsonValueToUStructProperty(const TSharedPtr<FJsonValue>& JsonValue, UStructProperty *StructProperty, void* OutValue)
{
...
bool UObjectDeliveryBoxUsingJson::JsonValueToUObjectProperty(const TSharedPtr<FJsonValue>& JsonValue, UObjectProperty *ObjectProperty, void* OutValue)
{
	if (JsonValue->Type == EJson::Object)
	{
